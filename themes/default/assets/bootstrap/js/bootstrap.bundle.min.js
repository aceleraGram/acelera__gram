...
!(function (t, e) {
      ...
      return (
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            var i = e(this),
              o = i.data(l);
            o || ((o = new t(this)), i.data(l, o)), "close" === n && o[n](this);
          });
        }),
  ...
  e(document).on(
    ...
    (e.fn[a].noConflict = function () {
      return (e.fn[a] = h), f._jQueryInterface;
    });
  var d = "button",
    p = "bs.button",
    m = "." + p,
    ...
    w = (function () {
      ...
      return (
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            var i = e(this).data(p);
            i || ((i = new t(this)), e(this).data(p, i)),
              "toggle" === n && i[n]();
          });
        }),
        i(t, null, [
  ...
  e(document)
    .on(b.CLICK_DATA_API, y, function (t) {
      t.preventDefault();
      var n = t.target;
      e(n).hasClass("btn") || (n = e(n).closest(E)),
    ...
    (e.fn[d].noConflict = function () {
      return (e.fn[d] = _), w._jQueryInterface;
    });
  var T = "carousel",
    C = "bs.carousel",
    S = "." + C,
    ...
    j = (function () {
      ...
      return (
        ...
        (n._getConfig = function (t) {
          return (t = o({}, A, t)), s.typeCheckConfig(T, t, O), t;
        }),
        ...
        (n._addTouchEventListeners = function () {
          ...
          if (this._touchSupported) {
            var n = function (e) {
                t._pointerEvent && H[e.originalEvent.pointerType.toUpperCase()]
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (i || ((i = new t(this, r)), e(this).data(C, i)),
              "number" == typeof n)
            )
              i.to(n);
  ...
  e(document).on(
    ...
    (e.fn[T].noConflict = function () {
      return (e.fn[T] = I), j._jQueryInterface;
    });
  var R = "collapse",
    F = "bs.collapse",
    M = "." + F,
    ...
    G = (function () {
      ...
      return (
        ...
        (n.show = function () {
          ...
          if (
            ...
            if ((e(this._element).trigger(r), !r.isDefaultPrevented())) {
              ...
              e(this._element)
                .one(s.TRANSITION_END, function () {
                  e(o._element).removeClass(Y).addClass(Q).addClass(K),
                    (o._element.style[a] = ""),
          ...
          if (!this._isTransitioning && e(this._element).hasClass(K)) {
            ...
            if ((e(this._element).trigger(n), !n.isDefaultPrevented())) {
              ...
              (this._element.style[i] =
                ...
                e(this._element).addClass(Y).removeClass(Q).removeClass(K);
                ...
                for (var r = 0; r < o; r++) {
                  ...
                  null !== l &&
                    (e([].slice.call(document.querySelectorAll(l))).hasClass(
                      ...
                      e(a).addClass(V).attr("aria-expanded", !1));
                }
              ...
              e(this._element)
                .one(s.TRANSITION_END, function () {
                  t.setTransitioning(!1),
                    e(t._element).removeClass(Y).addClass(Q).trigger(q.HIDDEN);
                })
                .emulateTransitionEnd(c);
            }
          }
        ...
        (n._addAriaAndCollapsedClass = function (t, n) {
          var i = e(t).hasClass(K);
          n.length && e(n).toggleClass(V, !i).attr("aria-expanded", i);
        }),
  ...
  e(document).on(q.CLICK_DATA_API, z, function (t) {
    ...
    (e.fn[R].noConflict = function () {
      return (e.fn[R] = W), G._jQueryInterface;
    });
  for (
    ...
    if (J && 0 <= navigator.userAgent.indexOf(Z[tt])) {
      $ = 1;
      break;
    }
  var et =
  ...
  function rt(t) {
    ...
    var e = it(t),
      ...
      i = e.overflowX,
      o = e.overflowY;
    return /(auto|scroll|overlay)/.test(n + o + i) ? t : rt(ot(t));
  }
  var st = J && !(!window.MSInputMethodContext || !document.documentMode),
    at = J && /MSIE 10/.test(navigator.userAgent);
  function lt(t) {
    return 11 === t ? st : 10 === t ? at : st || at;
  }
  function ct(t) {
  ...
  function ut(t, e) {
    ...
    if ((t !== l && e !== l) || i.contains(o))
      return "BODY" === (a = (s = l).nodeName) ||
        ("HTML" !== a && ct(s.firstElementChild) !== s)
        ? ct(l)
        : l;
    var c = ht(t);
    return c.host ? ut(c.host, e) : ut(t, ht(e).host);
  }
  function ft(t) {
    var e =
        "top" ===
  ...
  function Et(t) {
    ...
    if (l || c) {
      var h = it(t);
      (l -= dt(h, "x")), (c -= dt(h, "y")), (o.width -= l), (o.height -= c);
    }
    return yt(o);
  }
  function bt(t, e) {
  ...
  function wt(t) {
    ...
    for (var e = t.parentElement; e && "none" === it(e, "transform"); )
      e = e.parentElement;
    ...
    return (
      (void 0 === n
        ...
        t.enabled &&
          ...
          (e.offsets.reference = yt(e.offsets.reference)),
          (e = n(e, t)));
      }),
      e
    );
  ...
  var Rt = J && /Firefox/i.test(navigator.userAgent);
  function Ft(t, e, n) {
    var i = Ot(t, function (t) {
        return t.name === e;
      }),
        ...
        computeStyle: {
          ...
          fn: function (t, e) {
            ...
            var s,
              ...
              b = ct(t.instance.popper),
              w = Et(b),
              T = { position: o.position },
              C =
                ((s = t),
                (a = window.devicePixelRatio < 2 || !Rt),
            ...
            if (
              ((y =
                "bottom" === S
                  ? "HTML" === b.nodeName
                    ? -b.clientHeight + C.bottom
                    : -w.height + C.bottom
                  : C.top),
              (v =
                "right" === D
                  ? "HTML" === b.nodeName
                    ? -b.clientWidth + C.right
                    : -w.width + C.right
                  : C.left),
              E && I)
            )
              (T[I] = "translate3d(" + v + "px, " + y + "px, 0)"),
                (T[S] = 0),
                (T[D] = 0),
              ...
              var A = "bottom" === S ? -1 : 1,
                O = "right" === D ? -1 : 1;
              (T[S] = y * A), (T[D] = v * O), (T.willChange = S + ", " + D);
            }
            var N = { "x-placement": t.placement };
            return (
              (t.attributes = vt({}, N, t.attributes)),
              (t.styles = vt({}, T, t.styles)),
    ...
    qt = (function () {
      function t(e, n) {
        ...
        !(function (t, e) {
          ...
          (this.options = vt({}, t.Defaults, o)),
          (this.state = { isDestroyed: !1, isCreated: !1, scrollParents: [] }),
          (this.reference = e && e.jquery ? e[0] : e),
          (this.popper = n && n.jquery ? n[0] : n),
          (this.options.modifiers = {}),
          Object.keys(vt({}, t.Defaults.modifiers, o.modifiers)).forEach(
            function (e) {
              i.options.modifiers[e] = vt(
                {},
  ...
  var Kt = "dropdown",
    ...
    Gt = {
      ...
      SHOWN: "shown" + Yt,
      CLICK: "click" + Yt,
      CLICK_DATA_API: "click" + Yt + Vt,
      KEYDOWN_DATA_API: "keydown" + Yt + Vt,
      KEYUP_DATA_API: "keyup" + Yt + Vt,
    },
    Jt = "disabled",
    Zt = "show",
    ...
    oe = (function () {
      ...
      return (
        (n.toggle = function () {
          if (!this._element.disabled && !e(this._element).hasClass(Jt)) {
            var n = t._getParentFromElement(this._element),
              i = e(this._menu).hasClass(Zt);
            if ((t._clearMenus(), !i)) {
              ...
              if ((e(n).trigger(r), !r.isDefaultPrevented())) {
                ...
                "ontouchstart" in document.documentElement &&
                  ...
                  e(this._menu).toggleClass(Zt),
                  e(n).toggleClass(Zt).trigger(e.Event(Gt.SHOWN, o));
              }
            }
          }
        }),
        (n.show = function () {
          if (
            !(
              ...
              e(this._element).hasClass(Jt) ||
              e(this._menu).hasClass(Zt)
            )
          ) {
            ...
            e(o).trigger(i),
              i.isDefaultPrevented() ||
                (e(this._menu).toggleClass(Zt),
                e(o).toggleClass(Zt).trigger(e.Event(Gt.SHOWN, n)));
          }
        }),
        (n.hide = function () {
          if (
            ...
            e(o).trigger(i),
              i.isDefaultPrevented() ||
                (e(this._menu).toggleClass(Zt),
                e(o).toggleClass(Zt).trigger(e.Event(Gt.HIDDEN, n)));
          }
        }),
        (n.dispose = function () {
          e.removeData(this._element, Qt),
        ...
        (n._addEventListeners = function () {
          var t = this;
          e(this._element).on(Gt.CLICK, function (e) {
        ...
        (n._getConfig = function (t) {
          return (
            ...
            s.typeCheckConfig(Kt, t, this.constructor.DefaultType),
            t
          );
        }),
        ...
        (n._getPlacement = function () {
          ...
          return (
            t.hasClass("dropup")
              ? ((n = "top-start"),
                e(this._menu).hasClass($t) && (n = "top-end"))
              : t.hasClass("dropright")
              ? (n = "right-start")
              : t.hasClass("dropleft")
              ? (n = "left-start")
              : e(this._menu).hasClass($t) && (n = "bottom-end"),
            n
          );
        }),
                ...
                if (
                  ...
                  e(s).trigger(h),
                    h.isDefaultPrevented() ||
                      ...
                      e(c).removeClass(Zt),
                      e(s).removeClass(Zt).trigger(e.Event(Gt.HIDDEN, l)));
                }
              }
            }
        }),
              ...
              ? !(
                  ...
                  (27 !== n.which &&
                    ((40 !== n.which && 38 !== n.which) ||
                      e(n.target).closest(ee).length))
                )
              : zt.test(n.which)) &&
            (n.preventDefault(),
            n.stopPropagation(),
            !this.disabled && !e(this).hasClass(Jt))
          ) {
  ...
  e(document)
    .on(Gt.KEYDOWN_DATA_API, te, oe._dataApiKeydownHandler)
    .on(Gt.KEYDOWN_DATA_API, ee, oe._dataApiKeydownHandler)
    .on(Gt.CLICK_DATA_API + " " + Gt.KEYUP_DATA_API, oe._clearMenus)
    .on(Gt.CLICK_DATA_API, te, function (t) {
      t.preventDefault(),
        t.stopPropagation(),
        oe._jQueryInterface.call(e(this), "toggle");
    })
    .on(Gt.CLICK_DATA_API, ".dropdown form", function (t) {
      t.stopPropagation();
    }),
    (e.fn[Kt] = oe._jQueryInterface),
    (e.fn[Kt].Constructor = oe),
    (e.fn[Kt].noConflict = function () {
      return (e.fn[Kt] = Xt), oe._jQueryInterface;
    });
  var re = "modal",
    se = "bs.modal",
    ae = "." + se,
      ...
      return (
        ...
        (n.show = function (t) {
          ...
          if (!this._isShown && !this._isTransitioning) {
            ...
            var i = e.Event(ue.SHOW, { relatedTarget: t });
            e(this._element).trigger(i),
              this._isShown ||
                ...
                e(this._dialog).on(ue.MOUSEDOWN_DISMISS, function () {
                  e(n._element).one(ue.MOUSEUP_DISMISS, function (t) {
        ...
        (n.hide = function (t) {
          ...
          if (
            ...
            var i = e.Event(ue.HIDE);
            if (
              (e(this._element).trigger(i),
              this._isShown && !i.isDefaultPrevented())
            ) {
              this._isShown = !1;
              var o = e(this._element).hasClass(de);
              if (
                (o && (this._isTransitioning = !0),
                this._setEscapeEvent(),
                this._setResizeEvent(),
                e(document).off(ue.FOCUSIN),
                e(this._element).removeClass(pe),
                e(this._element).off(ue.CLICK_DISMISS),
                e(this._dialog).off(ue.MOUSEDOWN_DISMISS),
                o)
              ) {
        ...
        (n._getConfig = function (t) {
          return (t = o({}, ce, t)), s.typeCheckConfig(re, t, he), t;
        }),
        (n._showElement = function (t) {
          var n = this,
            i = e(this._element).hasClass(de);
          (this._element.parentNode &&
            ...
            e(this._element).addClass(pe),
            this._config.focus && this._enforceFocus();
          var o = e.Event(ue.SHOWN, { relatedTarget: t }),
            r = function () {
        ...
        (n._setEscapeEvent = function () {
          ...
          this._isShown && this._config.keyboard
            ? e(this._element).on(ue.KEYDOWN_DISMISS, function (e) {
                27 === e.which && (e.preventDefault(), t.hide());
              })
            : this._isShown || e(this._element).off(ue.KEYDOWN_DISMISS);
        }),
        (n._setResizeEvent = function () {
          var t = this;
          this._isShown
            ? e(window).on(ue.RESIZE, function (e) {
                return t.handleUpdate(e);
              })
            : e(window).off(ue.RESIZE);
        }),
        (n._hideModal = function () {
          ...
          (this._element.style.display = "none"),
            ...
            (this._isTransitioning = !1),
            this._showBackdrop(function () {
              e(document.body).removeClass(fe),
                t._resetAdjustments(),
                t._resetScrollbar(),
                e(t._element).trigger(ue.HIDDEN);
            });
        }),
        ...
        (n._showBackdrop = function (t) {
          var n = this,
            i = e(this._element).hasClass(de) ? de : "";
          if (this._isShown && this._config.backdrop) {
            if (
              ...
              e(this._element).on(ue.CLICK_DISMISS, function (t) {
        ...
        (t._jQueryInterface = function (n, i) {
          return this.each(function () {
            var r = e(this).data(se),
              s = o({}, ce, e(this).data(), "object" == typeof n && n ? n : {});
            if (
              (r || ((r = new t(this, s)), e(this).data(se, r)),
              "string" == typeof n)
            ) {
              if (void 0 === r[n])
                throw new TypeError('No method named "' + n + '"');
  ...
  e(document).on(ue.CLICK_DATA_API, '[data-toggle="modal"]', function (t) {
    var n,
      i = this,
      r = s.getSelectorFromElement(this);
    r && (n = document.querySelector(r));
    var a = e(n).data(se) ? "toggle" : o({}, e(n).data(), e(this).data());
    ("A" !== this.tagName && "AREA" !== this.tagName) || t.preventDefault();
    var l = e(n).one(ue.SHOW, function (t) {
      t.isDefaultPrevented() ||
        l.one(ue.HIDDEN, function () {
          e(i).is(":visible") && i.focus();
        });
    });
    _e._jQueryInterface.call(e(n), a, this);
  }),
    (e.fn[re] = _e._jQueryInterface),
    (e.fn[re].Constructor = _e),
    (e.fn[re].noConflict = function () {
      return (e.fn[re] = le), _e._jQueryInterface;
    });
  var ve = "tooltip",
    ye = "bs.tooltip",
    Ee = "." + ye,
    ...
    xe = (function () {
      ...
      return (
        ...
        (n.show = function () {
          ...
          if (this.isWithContent() && this._isEnabled) {
            ...
            r.setAttribute("id", a),
              ...
              this.setContent(),
              this.config.animation && e(r).addClass(Ne);
            var l =
            ...
            e(r).data(this.constructor.DATA_KEY, this),
              ...
              (this._popper = new qt(this.element, r, {
                placement: c,
                modifiers: {
            ...
            var u = function () {
              ...
              (t._hoverState = null),
                ...
                n === Ae && t._leave(null, t);
            };
            if (e(this.tip).hasClass(Ne)) {
        ...
        (n.addAttachmentClass = function (t) {
          e(this.getTipElement()).addClass(we + "-" + t);
        }),
        ...
        (n._enter = function (t, n) {
          ...
          (n = n || e(t.currentTarget).data(i)) ||
            ...
            t && (n._activeTrigger["focusin" === t.type ? Pe : Le] = !0),
            e(n.getTipElement()).hasClass(ke) || n._hoverState === Ie
              ? (n._hoverState = Ie)
        ...
        (n._leave = function (t, n) {
          ...
          (n = n || e(t.currentTarget).data(i)) ||
            ...
            e(t.currentTarget).data(i, n)),
            t && (n._activeTrigger["focusout" === t.type ? Pe : Le] = !1),
        ...
        (n._getConfig = function (t) {
          return (
            ...
            s.typeCheckConfig(ve, t, this.constructor.DefaultType),
            t
          );
        }),
  ...
  (e.fn[ve] = xe._jQueryInterface),
    (e.fn[ve].Constructor = xe),
    (e.fn[ve].noConflict = function () {
      return (e.fn[ve] = be), xe._jQueryInterface;
    });
  var He = "popover",
    je = "bs.popover",
    Re = "." + je,
    ...
    Be = o({}, xe.DefaultType, { content: "(string|element|function)" }),
    qe = {
      HIDE: "hide" + Re,
      HIDDEN: "hidden" + Re,
      SHOW: "show" + Re,
    ...
    Ke = (function (t) {
      ...
      (o = t),
        ...
        ((n.prototype.constructor = n).__proto__ = o);
      var s = r.prototype;
      return (
        ...
        (s.addAttachmentClass = function (t) {
          e(this.getTipElement()).addClass(Me + "-" + t);
        }),
        ...
        (r._jQueryInterface = function (t) {
          return this.each(function () {
            var n = e(this).data(je),
              i = "object" == typeof t ? t : null;
            if (
              (n || !/dispose|hide/.test(t)) &&
              (n || ((n = new r(this, i)), e(this).data(je, n)),
              "string" == typeof t)
            ) {
              if (void 0 === n[t])
  ...
  (e.fn[He] = Ke._jQueryInterface),
    (e.fn[He].Constructor = Ke),
    (e.fn[He].noConflict = function () {
      return (e.fn[He] = Fe), Ke._jQueryInterface;
    });
  var Qe = "scrollspy",
    Ye = "bs.scrollspy",
    Ve = "." + Ye,
    ...
    on = (function () {
      function t(t, n) {
        ...
        (this._element = t),
          ...
          e(this._scrollElement).on(Je.SCROLL, function (t) {
            return i._process(t);
          }),
          this.refresh(),
          this._process();
      ...
      return (
        ...
        (n._getConfig = function (t) {
          if (
            "string" !=
            typeof (t = o({}, ze, "object" == typeof t && t ? t : {})).target
          ) {
            var n = e(t.target).attr("id");
            n || ((n = s.getUID(Qe)), e(t.target).attr("id", n)),
              (t.target = "#" + n);
          }
          return s.typeCheckConfig(Qe, t, Ge), t;
        }),
        ...
        (n._activate = function (t) {
          ...
          i.hasClass("dropdown-item")
            ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(Ze),
              i.addClass(Ze))
            : (i.addClass(Ze),
              i
                .parents($e)
                .prev(tn + ", " + en)
                .addClass(Ze),
              i.parents($e).prev(".nav-item").children(tn).addClass(Ze)),
            e(this._scrollElement).trigger(Je.ACTIVATE, { relatedTarget: t });
        }),
        (n._clear = function () {
          [].slice
            .call(document.querySelectorAll(this._selector))
  ...
  e(window).on(Je.LOAD_DATA_API, function () {
    ...
    (e.fn[Qe].noConflict = function () {
      return (e.fn[Qe] = Xe), on._jQueryInterface;
    });
  var rn = "bs.tab",
    sn = "." + rn,
    an = e.fn.tab,
      ...
      return (
        (n.show = function () {
          ...
          if (
            ...
            if (o) {
              var a = "UL" === o.nodeName || "OL" === o.nodeName ? fn : un;
              i = (i = e.makeArray(e(o).find(a)))[i.length - 1];
            }
            var l = e.Event(ln.HIDE, { relatedTarget: this._element }),
              c = e.Event(ln.SHOW, { relatedTarget: i });
            if (
              (i && e(i).trigger(l),
              ...
              var h = function () {
                var n = e.Event(ln.HIDDEN, { relatedTarget: t._element }),
                  o = e.Event(ln.SHOWN, { relatedTarget: i });
        ...
        (n.dispose = function () {
          e.removeData(this._element, rn), (this._element = null);
        }),
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            var i = e(this),
              o = i.data(rn);
            if (
              (o || ((o = new t(this)), i.data(rn, o)), "string" == typeof n)
            ) {
              if (void 0 === o[n])
                throw new TypeError('No method named "' + n + '"');
              o[n]();
  ...
  e(document).on(
    ...
    function (t) {
      t.preventDefault(), dn._jQueryInterface.call(e(this), "show");
    }
  ),
    (e.fn.tab = dn._jQueryInterface),
    (e.fn.tab.Constructor = dn),
    (e.fn.tab.noConflict = function () {
      return (e.fn.tab = an), dn._jQueryInterface;
    });
  var pn = "toast",
    mn = "bs.toast",
    gn = "." + mn,
      ...
      return (
        ...
        (n.hide = function (t) {
          ...
          this._element.classList.contains(En) &&
            (e(this._element).trigger(vn.HIDE),
            t
              ? this._close()
        ...
        (n.dispose = function () {
          clearTimeout(this._timeout),
            ...
            e(this._element).off(vn.CLICK_DISMISS),
            e.removeData(this._element, mn),
            (this._element = null),
            (this._config = null);
        }),
        (n._getConfig = function (t) {
          return (
            ...
            s.typeCheckConfig(pn, t, this.constructor.DefaultType),
            t
          );
        }),
        (n._setListeners = function () {
        ...
        (n._close = function () {
          var t = this,
            n = function () {
              t._element.classList.add(yn), e(t._element).trigger(vn.HIDDEN);
            };
        ...
        (t._jQueryInterface = function (n) {
          return this.each(function () {
            ...
            if (
              (o ||
                ((o = new t(this, "object" == typeof n && n)), i.data(mn, o)),
              "string" == typeof n)
            ) {
              if (void 0 === o[n])
                throw new TypeError('No method named "' + n + '"');
  ...
  (e.fn[pn] = Cn._jQueryInterface),
    (e.fn[pn].Constructor = Cn),
    (e.fn[pn].noConflict = function () {
      return (e.fn[pn] = _n), Cn._jQueryInterface;
    }),
    (function () {
      if (void 0 === e)
        throw new TypeError(
